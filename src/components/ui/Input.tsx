      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            ref={ref}
            className={cn(
              // h-12 = 48px — comfortable tap height on mobile
              // text-base = 16px — PREVENTS iOS auto-zoom on focus (key fix!)
              "flex h-12 w-full rounded-lg border bg-white px-3 py-2 text-base",
