-- ============================================
-- Aiel Enterprises - COMPLETE RESET & SETUP
-- Run this single file to reset and recreate everything
-- ============================================
...
DO $$
BEGIN
  RAISE NOTICE '✅ Database setup complete! All tables, indexes, policies, and triggers created.';
END $$;
